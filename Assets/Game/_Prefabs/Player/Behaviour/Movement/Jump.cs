...
namespace Player{
    public class Jump : MonoBehaviour , IPlayerMovementAction
    {
        ...
        private IEnumerator IStartJump(){
            ...
            while (rigidBody.position.y - startY < jumpData.maxDistance && !movementData.CastCheck(rightPos) && !movementData.CastCheck(leftPos)){
        ...
        public void DoAction(InputAction.CallbackContext callback){
            ...
            void StartJump(){
                ...
                if (movementData.CastCheck(leftPos) || movementData.CastCheck(rightPos))
